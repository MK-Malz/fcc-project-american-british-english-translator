...
const TranslatorMachine = require('../components/translator.js');
let translator = new TranslatorMachine()
...
suite('Unit Tests', () => {
  ...
  test('Translate Mangoes are my favorite fruit. to British English', function(done) {
    ...
    assert.equal(translator.translate(input, locale), output);
    done();
  })
  ...
  test('Translate Have you met Mrs Kalyani? to American English', function(done) {
    ...
    let locale = 'british-to-american'
    let output = 'Have you met <span class="highlight">Mr.</span>s Kalyani?'
    assert.equal(translator.translate(input, locale), output);
    done();
  })
